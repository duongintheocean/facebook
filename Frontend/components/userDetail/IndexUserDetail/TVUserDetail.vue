      ...
      <div class="w-[1031px] m-auto">
        ...
        >
          <div class="flex justify-between w-full h-[36px] mb-2">
            <div class="text-[20px] font-bold">Chương trình TV</div>
              <div
          ...
          <div class="flex gap-4 mb-5">
            ...
            <button
                class="btn flex justify-center items-center w-[115px] h-full font-semibold text-[15px] pb-[12px]"
              >
                Chương trình TV
            </button>
          </div>
          <div class="text-center text-[24px] text-gray-500 font-bold">
            Không có đã xem để hiển thị
          </div>
        </div>
      </div>
    </div>
